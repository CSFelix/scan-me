...
public class EmailNovoCodigoAlteracaoSenhaThread implements Runnable {
	/*
	...
	public EmailNovoCodigoAlteracaoSenhaThread(String destinatario, String uuid_usuario, String uuid_alteracao_senha, String codigo_alteracao, int idioma) {
	...
	public void run() {
		...
		GerenciadorEmail gerenciador = new GerenciadorEmail(this.destinatario,
															...
															this.idioma);
		gerenciador.EnviarEmailNovoCodigoAlteracaoSenha();
	}
