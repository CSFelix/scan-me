...
<html lang="pt-br, en">
	...
	<body>
		...
		<section id="mainContent">
			...
			<jsp:include page="includes/sections-painel/painel-cadastro-produto.jsp" />
		</section>
	</body>

	<jsp:include page="includes/vue-produto.html" />
	<jsp:include page="includes/script-produto.html" />
</html>