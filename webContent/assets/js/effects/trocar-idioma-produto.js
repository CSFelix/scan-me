...
if (idiomaAtual) {
    ...
    // utilizado apenas para a tela de cadastro-produto, onde é traduzido os conteúdos da página
    try { vueAtivarControladorPainelCadastroProduto(); }
    catch (Exception) { }
    
    // utilizado apenas para a tela de alterar-produto, onde é traduzido os conteúdos da página
    try { vueAtivarControladorPainelAlterarProduto(); }
    catch (Exception) {  }
    
    // utilizado apenas para a tela de visualizar-produto, onde é traduzido os conteúdos da página
    try { 
    	vueAtivarControladorPainelVisualizarProduto();
    	vueAtivarControladorIdiomaModalQRCodeVisualizarProduto();
    }
    catch (Exception) { }
    
    // utilizado apenas para a tela de visualizar-produto, onde é traduzido os conteúdos do modal da página
    try { vueAtivarControladorIdiomaModalVisualizarProduto(); }
    catch (Exception) { }
}
