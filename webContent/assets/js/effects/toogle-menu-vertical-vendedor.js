...
// clique na opção de expandir e recolher menu
liToogleMenuVertical.addEventListener("click", () => {
	...
	if (toogleMenuVertical.classList.contains("fa-forward")) {
		...
		setTimeout(function () {
			...
			spanMenuVertical[6].style.visibility = "visible";
		}, 250);
	...
	// desexpandir menu
		...
		spanMenuVertical[6].style.visibility = "hidden";
	}
});

// clique na opção de esconder o menu
