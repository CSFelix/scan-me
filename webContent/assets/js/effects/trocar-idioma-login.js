...
if (idiomaAtual) {
    ...
    // utilizado apenas para a tela de cadastro-inicial, onde é traduzido os conteúdos do modal
    try { vueAtivarControladorIdiomaModalCadastro(); }
    catch (Exception) { }
    
    // utilizado apenas para a tela de esqueceu-senha, onde é traduzido os conteúds do modal
    try { vueAtivarControladorIdiomaModalEsqueceuSenha(); }
    catch (Exception) { }
    
    // utilizado apenas para a tela de alteracao-senha, onde é traduzido os conteúds do modal
    try { vueAtivarControladorIdiomaModalAlteracaoSenha(); }
    catch (Exception) { }
}
